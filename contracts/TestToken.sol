...
contract TestGovernanceToken is Context, IERC20, IERC20Metadata {
    ...
    function createPool(address _tokenB, uint24 _fee) public onlyOwner {
        ...
        // nonFungiblePositionManager.createAndInitializePoolIfNecessary(address(this), _tokenB, _fee, 1);
        uniswapV3Pair = UniswapV3Factory(uniswapV3Factory).createPool(address(this), _tokenB, _fee);
    }
